...
public final class SpaceInvadersGame {
     ...
     *        tuiles).
     */
    public SpaceInvadersGame(int height, int width, String theme) {
        this.grid = new GameGrid(height, width);
        this.spriteStore = new SpriteStore(theme);
    }
...
;    }
    ...
    public void start() {
        ...
        controller.setHealth(ship.getHealthProperty());
        controller.setScore(score);
        // On ajoute ensuite les aliens.
        nbRemainingAliens = grid.getWidth() / 2;
    ...
    /**
     * Permet de stocker le controller.
     *
     * @param controller Controller SpaceInvaders.
     */
