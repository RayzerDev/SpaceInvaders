...
import fr.univartois.butinfo.ihm.spaceinvaders.controller.SelectThemeController;
...
public class SpaceInvadersApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("./view/select-theme.fxml"));
        Parent viewContent = fxmlLoader.load();
        
        SelectThemeController controller = fxmlLoader.getController();
