...
public final class Tile {
     ...
     */
    private final ObjectProperty<AbstractMovable> movableProperty;
    ...
    public Tile(int row, int column) {
        this.row = row;
        this.column = column;
        this.movableProperty = new SimpleObjectProperty<>();
    }
    ...
    /**
     * Donne le property mobile se trouvant sur cette tuile.
     *
     * @return Le property.
     */
    ...
    public void setMovable(AbstractMovable movableObject) {
       movableProperty.set(movableObject);
    }
    ...
    public boolean isEmpty() {
        return movableProperty.get()==null;
    }
